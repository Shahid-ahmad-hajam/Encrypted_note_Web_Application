...
'''
db: A variable that stores the connection object. This object is primary interface for all further 
database operations. db is used to create cursors and manage transactions.'''
...
db = mysql.connector.connect( #Creates a connection between Python program and MySQL database server.
    ...
    password="Shahid@123",  # Replace with MySQL password
    database="shahid1"  # Replace with database name
)
